...
final class DataParsingTests: XCTestCase {
    func testParseFilmFromJson() {
        ...
        let film = JSONDecoder().decode(Film.self, from: jsonData)
...
final class SearchViewModelTests: XCTestCase {
    func testEmptySearch() {
        ...
        XCTAssertEqualFalse(viewModel.isLoading)
    }
}
...
final class SortCountriesTests: XCTestCase {
    func testPrefferedCountries() {
        ...
        let sortedCountries = Country.getPreffered(countries: countries, preffered: .it)
